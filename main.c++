...
int main()
{
    ...
    do
    {
        ...
        cout << "8. hashing implementation" << endl;
        ...
        else if (option == 2)
        {
            ...
            int id = searchidbyname(tempNode, player);
            if (id != 0)
            {
        ...
        else if (option == 5)
        {
            ...
            node *tempNode = head;
            int id1 = searchidbyname(tempNode, player1);
            if (id1 != 0)
            {
                ...
                int id2 = searchidbyname(tempNode2, player2);
                if (id2 != 0)
                {
        ...
        else if (option == 6)
        {
            ...
            string shirtNumber;
            cin >> shirtNumber;
            printPlayerNamesByShirt(temp, shirtNumber);
        }
        ...
        else if (option == 8)
        {
            ...
            player[0] = toupper(player[0]);
            node *tempNode3 = head;
            int id = searchidbyname(tempNode3, player);
            temp = obj.recursiveSearch(obj.root, id);
            string url = temp->value[6];
            cout << "URL of the player is " << url << endl;
            string hashedURL = shortenURL(url);
            cout<< " Shorten URL is:\t "<< hashedURL<< endl;
